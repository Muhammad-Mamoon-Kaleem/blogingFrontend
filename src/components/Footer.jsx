            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between items-center md:items-start space-y-6 md:space-y-0 text-center md:text-left">
                ...
                <div className="flex-1">
                    ...
                    <ul className="mt-2 space-y-2">
                        <li>
                            <Link to="/allblogs/Eco-Products" className="hover:text-green-500">
                                Eco-Products
                            </Link>
                        </li>
                        <li>
                            <Link to="/allblogs/Places" className="hover:text-green-500">
                                Places
                            </Link>
                        </li>
                        <li>
                            <Link to="/allblogs/Green Environment" className="hover:text-green-500">
                                Green Environment
                            </Link>
                        </li>
                    </ul>
